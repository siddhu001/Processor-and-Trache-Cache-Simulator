...
{
  "$end", "error", "$undefined", "HEXNUM", "NEWLINE", "END1", "$accept",
  "root", "numbers", "number", YY_NULLPTR
};
#endif
...
#line 26 "parser.y" /* yacc.c:1646  */
    { numofinstructions = memidx; goProcessor(); exit(0);}
...
#line 35 "parser.y" /* yacc.c:1646  */
    { storeInMem((yyvsp[0].hexStr), memidx); memidx++;}
